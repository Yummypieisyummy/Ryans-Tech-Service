...
import keystoneSetupImage from "../assets/Keystone Setup.jpg";
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center">
            ...
            <div className="p-6 flex-1 flex flex-col justify-between">
              ...
              <p className="text-gray-700 mb-4">
                Setup and configuration of a PSSA testing site, including
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center">
            ...
            <div className="p-6 flex-1 flex flex-col justify-between">
              ...
              <p className="text-gray-700 mb-4">
                Setup and configuration of a Keystone testing site, an especially small room with limited space for hardware and equipment.
              </p>
            </div>
          </div>
        </div>
